...
**[Youtube_Copy]** is a project for microverse mini bootcamp, using html and css
...
```sh
  cd my-folder
  git clone git@github.com:GreetyCr/project_review
```
...
I would like to thank Microverse for this lesson and the resources to code this clone
